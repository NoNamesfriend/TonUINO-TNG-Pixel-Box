...
void Neo_pixels::animVolume()
{
  ...
  uint8_t onPixels = map(Tonuino::getTonuino().getMp3().getVolume(), Tonuino::getTonuino().getMp3().getMinVolume(), Tonuino::getTonuino().getMp3().getMaxVolume(), 1, pixels.numPixels());
